...
public final class TeenageMutantNinjaTurtles extends ExpansionSet {
    ...
    private TeenageMutantNinjaTurtles() {
        ...
        cards.add(new SetCardInfo("Forest", 309, Rarity.LAND, mage.cards.basiclands.Forest.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Fugitive Droid", 40, Rarity.UNCOMMON, mage.cards.f.FugitiveDroid.class));
        ...
        cards.add(new SetCardInfo("Island", 306, Rarity.LAND, mage.cards.basiclands.Island.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Manhole Missile", 94, Rarity.COMMON, mage.cards.m.ManholeMissile.class));
        ...
        cards.add(new SetCardInfo("Michelangelo, Game Master", 118, Rarity.COMMON, mage.cards.m.MichelangeloGameMaster.class));
        ...
        cards.add(new SetCardInfo("Michelangelo, Mutant BFF", 120, Rarity.UNCOMMON, mage.cards.m.MichelangeloMutantBFF.class, NON_FULL_USE_VARIOUS));
        cards.add(new SetCardInfo("Michelangelo, Mutant BFF", 198, Rarity.UNCOMMON, mage.cards.m.MichelangeloMutantBFF.class, NON_FULL_USE_VARIOUS));
        ...
        cards.add(new SetCardInfo("Mountain", 308, Rarity.LAND, mage.cards.basiclands.Mountain.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Paramecia Coloniex", 70, Rarity.UNCOMMON, mage.cards.p.ParameciaColoniex.class));
        cards.add(new SetCardInfo("Party Dude", 128, Rarity.RARE, mage.cards.p.PartyDude.class));
        cards.add(new SetCardInfo("Pizza Face, Gastromancer", 163, Rarity.UNCOMMON, mage.cards.p.PizzaFaceGastromancer.class));
        ...
        cards.add(new SetCardInfo("Plains", 305, Rarity.LAND, mage.cards.basiclands.Plains.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Rocksteady, Crash Courser", 131, Rarity.COMMON, mage.cards.r.RocksteadyCrashCourser.class));
        ...
        cards.add(new SetCardInfo("Swamp", 307, Rarity.LAND, mage.cards.basiclands.Swamp.class, FULL_ART_BFZ_VARIOUS));
        ...
        cards.add(new SetCardInfo("Venus, Torn Between Worlds", 136, Rarity.UNCOMMON, mage.cards.v.VenusTornBetweenWorlds.class));
        ...
        cards.add(new SetCardInfo("West Wind Avatar", 137, Rarity.UNCOMMON, mage.cards.w.WestWindAvatar.class));
        cards.add(new SetCardInfo("Wingnut, Bat on the Belfry", 110, Rarity.UNCOMMON, mage.cards.w.WingnutBatOnTheBelfry.class));
