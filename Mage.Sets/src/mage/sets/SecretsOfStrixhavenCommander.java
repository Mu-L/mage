...
public final class SecretsOfStrixhavenCommander extends ExpansionSet {
    ...
    private SecretsOfStrixhavenCommander() {
        ...
        cards.add(new SetCardInfo("Coastal Peak", 52, Rarity.RARE, mage.cards.c.CoastalPeak.class));
        ...
        cards.add(new SetCardInfo("Defacing Duskmage", 45, Rarity.RARE, mage.cards.d.DefacingDuskmage.class));
        ...
        cards.add(new SetCardInfo("Expansion Algorithm", 19, Rarity.RARE, mage.cards.e.ExpansionAlgorithm.class));
        ...
        cards.add(new SetCardInfo("Turbulent Fen", 55, Rarity.RARE, mage.cards.t.TurbulentFen.class));
